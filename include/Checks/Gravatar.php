...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						new Gravatar_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all("Support of standard avatar functions"), array('get_avatar','World') , 'ut_gravatar.zip'),
			);
    }
}