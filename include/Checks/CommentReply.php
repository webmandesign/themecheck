...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						new CommentReply_Checker(TT_WORDPRESS, ERRORLEVEL_ERROR, __all("Declaration of comment reply"), array('/wp_enqueue_script\(\s?("|\')comment-reply("|\')/i','/comment-reply/'), 'ut_commentreply_enqueue_script.zip')
			);
    }
}