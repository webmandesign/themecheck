...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						new Iframes_Checker(TT_COMMON, ERRORLEVEL_CRITICAL, __all('iframes are sometimes used to load unwanted adverts and malicious code on another site'), '/<(iframe +.*src=)[^>]*>/', 'ut_iframes.zip')
			);
    }
}