...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						new SearchForm_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Implementation'), '/(include\s?\(\s?TEMPLATEPATH\s?\.?\s?["|\']\/searchform.php["|\']\s?\))/', 'ut_searchform.zip'),
			);
    }
}