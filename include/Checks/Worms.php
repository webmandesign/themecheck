...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						...
						new Worms_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Possible Ekibastos attack <a href="http://ocaoimh.ie/did-your-wordpress-site-get-hacked/" target="_blank">http://ocaoimh.ie/did-your-wordpress-site-get-hacked/</a>'), '/ekibastos/', "ut_worms_ekibastos.zip"),
