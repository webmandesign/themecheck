...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						new Includes_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Use of include or require'), '/(?<![a-z0-9_])(?:requir|includ)e(?:_once){0}\s?\(/', 'ut_includes.zip'),
			);
    }
}