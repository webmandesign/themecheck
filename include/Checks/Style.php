...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						...
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of theme description'), array('[ \t\/*#]*Description:', __all('<strong>Description:</strong> is missing from style.css header.')), "ut_style_description.zip"),
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of theme author'), array('[ \t\/*#]*Author:',__all('<strong>Author:</strong> is missing from style.css header.')), "ut_style_author.zip"),
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of theme version'), array('[ \t\/*#]*Version', __all('<strong>Version:</strong> is missing from style.css header.')), "ut_style_version.zip"),
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of license type'), array('[ \t\/*#]*License:', __all('<strong>License:</strong> is missing from style.css header.')), "ut_style_license.zip"),
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of license url'), array('[ \t\/*#]*License URI:', __all('<strong>License URI:</strong> is missing from style.css header.')), "ut_style_license_uri.zip"),
						...
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of .wp-caption class'), array('\.wp-caption', __all('<strong>.wp-caption</strong> css class is needed in theme css.')), "ut_style_wp_caption.zip"),
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of .wp-caption-text class'), array('\.wp-caption-text', __all('<strong>.wp-caption-text</strong> css class is needed in theme css.')), "ut_style_wp_caption_text.zip"),
						new Style_Checker(TT_WORDPRESS | TT_WORDPRESS_CHILD, ERRORLEVEL_CRITICAL, __all('Presence of .gallery-caption class'), array('\.gallery-caption', __all('<strong>.gallery-caption</strong> css class is needed in theme css.')), "ut_style_gallery_caption.zip"),
