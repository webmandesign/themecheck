...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						...
						new Style_Checker('STYLE_STICKY_CLASS', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .sticky class'), array('\.sticky', __all('<strong>.sticky</strong> css class is needed in theme css.')), "ut_style_sticky.zip"),
						new Style_Checker('STYLE_BYPOSTAUTHOR', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .bypostauthor class'), array('\.bypostauthor', __all('<strong>.bypostauthor</strong> css class is needed in theme css.')), "ut_style_bypostauthor.zip"),
						new Style_Checker('STYLE_ALIGNLEFT', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .alignleft class'), array('\.alignleft', __all('<strong>.alignleft</strong> css class is needed in theme css.')), "ut_style_alignleft.zip"),
						new Style_Checker('STYLE_ALIGNRIGHT', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .alignright class'), array('\.alignright', __all('<strong>.alignright</strong> css class is needed in theme css.')), "ut_style_alignright.zip"),
						new Style_Checker('STYLE_ALIGNCENTER', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .aligncenter class'), array('\.aligncenter', __all('<strong>.aligncenter</strong> css class is needed in theme css.')), "ut_style_aligncenter.zip"),
						new Style_Checker('STYLE_WP_CAPTION', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .wp-caption class'), array('\.wp-caption', __all('<strong>.wp-caption</strong> css class is needed in theme css.')), "ut_style_wp_caption.zip"),
						new Style_Checker('STYLE_WP_CAPTION_TEXT', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .wp-caption-text class'), array('\.wp-caption-text', __all('<strong>.wp-caption-text</strong> css class is needed in theme css.')), "ut_style_wp_caption_text.zip"),
						new Style_Checker('STYLE_GALLERY_APTION', TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of .gallery-caption class'), array('\.gallery-caption', __all('<strong>.gallery-caption</strong> css class is needed in theme css.')), "ut_style_gallery_caption.zip"),
