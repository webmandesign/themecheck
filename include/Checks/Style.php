...
{	
    protected function createChecks()
    {
			...
			$this->checks = array(
						new Style_Checker(TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of theme name'), array('[ \t\/*#]*Theme Name:', __all('<strong>Theme name:</strong> is missing from style.css header.')), 'ut_style_theme_name.zip'),
						new Style_Checker(TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of theme description'), array('[ \t\/*#]*Description:', __all('<strong>Description:</strong> is missing from style.css header.')), "ut_style_description.zip"),
						new Style_Checker(TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of theme author'), array('[ \t\/*#]*Author:',__all('<strong>Author:</strong> is missing from style.css header.')), "ut_style_author.zip"),
						new Style_Checker(TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of theme version'), array('[ \t\/*#]*Version', __all('<strong>Version:</strong> is missing from style.css header.')), "ut_style_version.zip"),
						new Style_Checker(TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of license type'), array('[ \t\/*#]*License:', __all('<strong>License:</strong> is missing from style.css header.')), "ut_style_license.zip"),
						new Style_Checker(TT_WORDPRESS, ERRORLEVEL_CRITICAL, __all('Presence of license url'), array('[ \t\/*#]*License URI:', __all('<strong>License URI:</strong> is missing from style.css header.')), "ut_style_license_uri.zip"),
